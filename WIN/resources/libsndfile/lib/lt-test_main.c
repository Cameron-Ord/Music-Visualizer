...
/* src/.libs/lt-test_main.c - temporary wrapper executable for .libs/test_main.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-5

   The src/test_main program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_main.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.7 Debian-2.4.7-5\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# src/test_main - temporary wrapper script for .libs/test_main.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-5\n", f);
  fputs ("#\n", f);
  fputs ("# The src/test_main program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_main.exe:src/test_main:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.7 Debian-2.4.7-5\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_main.exe:src/test_main:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_main.exe:src/test_main:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
