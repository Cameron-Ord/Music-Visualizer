...
public:
  ...
  void render_set_directory_limiter(size_t vec_size, std::pair<int, int> win_size);
  ...
  void render_set_text_bg(std::pair<int, int> sizes, size_t draw_limit, size_t draw_index,
