...
class SDL2Fonts {
   public:
    ...
    void create_dir_text(const std::vector<Directory> d, SDL_Renderer *r, const SDL_Color color, TTF_Font *font,
    ...
    bool open_font();
    Text create_text(const std::string text, TTF_Font *font, SDL_Renderer *r, const size_t text_id,
