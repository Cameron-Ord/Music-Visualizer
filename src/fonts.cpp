...
void SDL2Fonts::create_dir_text(const std::vector<Directory> d, SDL_Renderer *r, const SDL_Color color, TTF_Font *font,
...
void SDL2Fonts::create_file_text(const std::vector<Files> f, SDL_Renderer *r, const SDL_Color color, TTF_Font *font,
                                 const size_t *text_limit) {
    for (auto it = song_text_vec.begin(); it != song_text_vec.end(); it++) {
        destroy_file_text(it);
    }
...
void SDL2Fonts::destroy_file_text(std::vector<std::vector<Text>>::iterator &file_vec) {
...
void SDL2Fonts::destroy_dir_text(std::vector<std::vector<Text>>::iterator &dir_vec) {
...
SDL_Surface *SDL2Fonts::create_text_surface(TTF_Font *font, const SDL_Color color, const std::string text) {
...
SDL_Texture *SDL2Fonts::create_text_texture(SDL_Renderer *r, SDL_Surface *surf) {
...
Text SDL2Fonts::create_text(const std::string text, TTF_Font *font, SDL_Renderer *r, const size_t text_id,
