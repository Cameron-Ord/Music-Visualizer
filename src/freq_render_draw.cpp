...
void SDL2Renderer::render_draw_bars(size_t *len, float *smear, float *smooth, const int *win_height,
                                    const int *win_width, SDL_Color *prim, SDL_Color *sec, SDL_Renderer *r) {
